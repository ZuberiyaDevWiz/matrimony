            ...
            <section>
                <div className=" bg-gray-200 w-fit">
                    <div className="userinfo col-start-2 col-span-4">
                        <h1 className="text-xl text-gray-400 font-bold pl-4 mb-3">
                            My Alerts Manager
                        </h1>
                        <p className="mb-5 pl-4">
                            Manage your subscription to .com Alerts on email listed below. You can
                            also subscribe to .com and .com Newsletters
                        </p>

                        <h1 className="text-xl text-gray-400 font-bold mb-4 pl-4">My Alerts </h1>
                        <form>
