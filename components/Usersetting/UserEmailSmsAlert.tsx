                ...
                <div className="w-fit mx-auto">
                    <div className="grid grid-cols-4">
                        <div className="userinfo col-start-2 col-span-4">
                            <h1 className="text-xl font-bold pl-4 mb-3">My Alerts Manager</h1>
                            <p>
                                Manage your subscription to .com Alerts on email listed below. You
                                can also subscribe to .com and .com Newsletters
                            </p>

                            <h1 className="text-xl mt-5 font-bold pl-4">My Alerts </h1>
                            <form>
                                <div className=" bg-white pt-5 text-base">
                                    ...
                                    <div className=" grid grid-cols-2 pt-4 border-b-2 border-gray-200 space-x-6 ">
                                        <div className="pl-4 ">
                                            ...
                                            <p className="">
                                                An email notification of Members who h
                                            </p>
                                        </div>
                                        <div className="">
                                            <h4 className="font-bold mb-2">Email Alert</h4>
                                    ...
                                    <div className=" grid grid-cols-2 pt-4 border-b-2 border-gray-200 space-x-6 ">
                                        <div className="pl-4 ">
                                            <h4 className="font-bold mb-2">
                                                Massage Received Alert
                                            </h4>
                                            <p className="">
                                                An email notification of new messages received
                                                recently
                                            </p>
                                        </div>
                                        <div className="">
                                ...
                                <h1 className="text-xl mt-5 font-bold pl-4">
                                ...
                                <div className="flex justify-between mt-10">
                                    <p>
                                        All your Shaadi.com emails and shaadi times newsletters will
                                        be dlivered to{' '}
                                        <span className="text-blue-500">
                                            rasheedsk14131@gmail.com.
                                        </span>
                                        <p>
...
export default UserAlertOption;
